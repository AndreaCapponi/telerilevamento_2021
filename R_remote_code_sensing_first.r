...
#Syntaxis' function for Windows is: example 1 <- brick('example 2')
...
#In R, visualizing informations of an object, name of it followed by enter as physical command
#In p224r63_2011 I want to obtain visually frequence bands
