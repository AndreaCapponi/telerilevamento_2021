...
#Without exploiting the plot function singularly on each raster layer object or "enhancing" through the par function to organize them in a prearrenged multiframe, 
#Without exploiting the plot function individually on each level raster object or enhancing it through the par function to organize the same level raster objects in a pre-established multiframe, through the previous functions - rlist, lapply and stack - I have the possibility to exploit the plot function directly on the multilevel raster object created by the initial objects organized in a list
